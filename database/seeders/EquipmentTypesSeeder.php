...
class EquipmentTypesSeeder extends Seeder
{
    ...
    private array $types = [
        [
            ...
            'image_url'   => 'https://innovationirs.com/storage/equipment-types/excavator-parts.jpg',
        ],
        [
            'name'        => 'Backhoe',
            'sort_order'  => 2,
            ...
            'image_url'   => 'https://innovationirs.com/storage/equipment-types/backhoe-parts.jpg',
        ],
        [
            'name'        => 'Bulldozer',
            'sort_order'  => 3,
            ...
            'image_url'   => 'https://innovationirs.com/storage/equipment-types/bulldozer-parts.jpg',
        ],
        [
            'name'        => 'Track Loader',
            'sort_order'  => 4,
            ...
            'image_url'   => 'https://innovationirs.com/storage/equipment-types/track-loader-parts.jpg',
        ],
        [
            'name'        => 'Wheel Loader',
            'sort_order'  => 5,
            ...
            'image_url'   => 'https://innovationirs.com/storage/equipment-types/wheel-loader-parts.jpg',
        ],
        [
            'name'        => 'Skid Steer',
            'sort_order'  => 6,
            ...
            'image_url'   => 'https://innovationirs.com/storage/equipment-types/skid-steer-parts.jpg',
        ],
        [
            'name'        => 'Feller Buncher',
            'sort_order'  => 7,
            ...
            'image_url'   => 'https://innovationirs.com/storage/equipment-types/feller-buncher-parts.jpg',
        ],
        [
            'name'        => 'Off Road Truck',
            'sort_order'  => 8,
            ...
            'image_url'   => 'https://innovationirs.com/storage/equipment-types/off-road-truck-parts.jpg',
        ],
        [
            'name'        => 'Motor Grader',
            'sort_order'  => 9,
            ...
            'image_url'   => 'https://innovationirs.com/storage/equipment-types/motor-grader-parts.jpg',
        ],
        [
            'name'        => 'Compactor',
            'sort_order'  => 10,
            ...
            'image_url'   => 'https://innovationirs.com/storage/equipment-types/compactor-parts.jpg',
        ],
    ];
